...
function Igstory(username){
	return new Promise(async(resolve, reject) => {
		...
		axios.post('https://www.instagramsave.com/system/action.php',qs.stringify(Setting.data), { headers: Setting.headers })
		.then(({ data }) => {
		resolve(data.medias)
		   })
		})
